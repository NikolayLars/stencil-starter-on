...
| `imageMastercard`    | `image-mastercard` |             | `string`   | `'pngfind.com-master-card-logo-png-2088342.png'` |
| `imagePayPal`        | `image-pay-pal`    |             | `string`   | `'clipart4300803.png'`                           |
| `imageTwitter`       | `image-twitter`    |             | `string`   | `'Twitter.png'`                                  |
| `imageVisa`          | `image-visa`       |             | `string`   | `'PikPng.com_visa-png_810129.png'`               |
